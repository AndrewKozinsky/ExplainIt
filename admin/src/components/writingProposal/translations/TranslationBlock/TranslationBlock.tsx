...
function TranslationBlock(props: TranslationBlockPropType) {
	...
	return (
		<SmallContentWrapper extraClass='translation-block'>
			<EngProposals blockId={block.id} engProposals={block.engProposals} />
			<Analysis blockId={block.id} text={block.analysis} />
			<Switchers blockId={block.id} checked={block.isChecked} correct={block.isCorrect} />
